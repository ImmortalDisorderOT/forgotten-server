...
{
	public:
		// changed this area for extended map view 
		static constexpr int32_t maxClientViewportX = 14; // default is 8
		static constexpr int32_t maxClientViewportY = 10; // default is 6
		static constexpr int32_t maxViewportX = maxClientViewportX + 2; //min value: maxClientViewportX + 1
		static constexpr int32_t maxViewportY = maxClientViewportY + 2; //min value: maxClientViewportY + 1

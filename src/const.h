...
//[3000 - 4000];
static constexpr int32_t PSTRG_TITLES_RANGE_START = (PSTRG_RESERVED_RANGE_START + 3000);
static constexpr int32_t PSTRG_TITLES_RANGE_SIZE = 1000;
static constexpr int32_t PSTRG_TITLES_CURRENTTITLE = (PSTRG_TITLES_RANGE_START + 1000);

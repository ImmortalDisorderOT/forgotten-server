...
class Game
{
	public:
		...
		//void playerToggleOutfitExtension(uint32_t playerId, int mount, int wings, int aura, int shader, int title);
		void playerToggleOutfitExtension(uint32_t playerId, int mount);

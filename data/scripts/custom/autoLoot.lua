local autoloot = {
    talkaction = "!autoloot",
    storageBase = PlayerStorageKeys.autoLootBase,
    freeAccountLimit = 10,
    premiumAccountLimit = 10,
    currencyToBank = false
}

local currencyItems = {}
if autoloot.currencyToBank then
    --for index, item in pairs(Game.getCurrencyItems()) do -- TODO: add this function
        --currencyItems[item:getId()] = true
    --end
    currencyItems[2160] = true
    currencyItems[2148] = true
    currencyItems[2152] = true
end
...
local function lootCorpse(corpsePosition)

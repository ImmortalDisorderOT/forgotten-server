...
--{x = 1589, y = 1382, z = 7} player spawn
-- top left {x = 1467, y = 1277, z = 7}
-- bot right  {x = 1731, y = 1471, z = 7}
-- total width 264
-- total height 194

local MAPS = {
    [1] = {
        startX = 1467, startY = 1277, startZ = 7,
        width = 264, height = 194,
        randonFillPercent = 50,
        roomTheresholdSize = 50,
        wallTheresholdSize = 100,
        playerSpawn ={x=117, y=100, size=10},
        map = {},

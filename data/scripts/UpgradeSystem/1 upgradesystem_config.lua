...
US_CONFIG = {
  {
    ...
    [ITEM_UPGRADE_CRYSTAL] = 42901, -- Upgrade Crystal item id
    [ITEM_ENCHANT_CRYSTAL] = 42902, -- Enchantment Crystal item id
    [ITEM_ALTER_CRYSTAL] = 42903, -- Alteration Crystal item id
    [ITEM_CLEAN_CRYSTAL] = 42904, -- Cleansing Crystal item id
    [ITEM_FORTUNE_CRYSTAL] = 42905, -- Fortune Crystal item id
    [ITEM_FAITH_CRYSTAL] = 42998 -- Faith Crystal item id
  },
  ITEM_MIND_CRYSTAL = 42908, -- Mind Crystal item id
  ITEM_LIMITLESS_CRYSTAL = 42909, -- Limitless Crystal item id
  ITEM_MIRRORED_CRYSTAL = 42907, -- Mirrored Crystal item id
  ...
  --
  MAX_ITEM_LEVEL = 1000, -- max that Item Level can be assigned to item
